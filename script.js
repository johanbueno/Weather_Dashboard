...
$("#citySearch").on("click", function (event) {
    ...
    cities.push(city);
    var queryURL = "https://api.openweathermap.org/data/2.5/weather?q=" + city + ",USA&appid=" + APIKey;
    ...
    $.ajax({
        ...
        var forecastUrl = "http://api.openweathermap.org/data/2.5/forecast?q=" + city + ",USA&appid=" + APIKey;;
